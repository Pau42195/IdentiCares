...
public class GestorDB {
    ...
    private class DBHandler extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("ALTER TABLE " + DiccionariDef.TABLE_NAME + " RENAME TO "  + DiccionariDef.TABLE_NAME + "V" + oldVersion);
            db.execSQL("ALTER TABLE " + ProvesDef.TABLE_NAME + " RENAME TO "  + ProvesDef.TABLE_NAME + "V" + oldVersion);
            db.execSQL("ALTER TABLE " + ResultatsDef.TABLE_NAME + " RENAME TO "  + ResultatsDef.TABLE_NAME + "V" + oldVersion);
    ...
    private static final String Diccionari_TABLE_CREATE = "create table " + DiccionariDef.TABLE_NAME
            ...
            + DiccionariDef.Codi + " text unique not null, "
